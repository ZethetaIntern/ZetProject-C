  ...
  return (
    <div className={style.wrapperClass}>
      <div className={style.containerClass}>
        ...
        {variant === 'page' && error.stack && (
          <div className="text-left w-full border-t border-[var(--border-color)] pt-3">
            <button
            ...
            {showStack && (
              <pre className="mt-2 p-3 bg-[var(--bg-dashboard)] rounded text-[10px] text-[var(--text-secondary)] overflow-x-auto max-h-40 leading-relaxed font-mono">
                {error.stack}
              </pre>
            )}
          </div>
