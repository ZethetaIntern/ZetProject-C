...
export const ToastItem = ({ toast }) => {
  ...
  const icons = {
    success: <svg style={{ width: "16px", height: "16px", color: "var(--color-up)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
      </svg>,
    error: <svg style={{ width: "16px", height: "16px", color: "var(--color-down)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
      </svg>,
    warning: <svg style={{ width: "16px", height: "16px", color: "var(--color-warning)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
      </svg>,
    info: <svg style={{ width: "16px", height: "16px", color: "var(--color-info)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
