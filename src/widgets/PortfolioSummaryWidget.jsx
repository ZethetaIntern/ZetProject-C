...
export const PortfolioSummaryWidget = () => {
  ...
  return <div className="flex flex-col gap-4 h-full text-xs select-text justify-between">
      {
    /* Primary KPI Metrics */
  }
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 bg-[var(--bg-dashboard)]/60 rounded border border-[var(--border-color)] flex flex-col justify-center">
          ...
          <span
    className={`text-[10px] font-semibold mt-1 flex items-center gap-1 ${isUp ? "text-[var(--color-up)]" : "text-[var(--color-down)]"}`}
  >
