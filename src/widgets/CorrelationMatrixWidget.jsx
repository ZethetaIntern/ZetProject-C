...
export const CorrelationMatrixWidget = () => {
  ...
  return <div className="flex flex-col h-full gap-2 text-xs select-none">
    ...
    /* Table header headers */
        ...
        <div className="grid grid-cols-6 gap-1 font-semibold text-[8px] text-[var(--text-secondary)] text-center uppercase tracking-wider mb-1">
          ...
          {assets.map((asset) => <div key={asset} className="truncate" title={asset}>
              {asset.substring(0, 4)}
            </div>)}
        </div>
    ...
    /* Matrix Rows */
        ...
        <div className="flex flex-col gap-1">
          {matrix.map((row, rIdx) => <div key={rIdx} className="grid grid-cols-6 gap-1 items-center">
